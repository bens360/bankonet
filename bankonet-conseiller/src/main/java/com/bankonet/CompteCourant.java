...
public class CompteCourant extends Compte {
	...
	@Column(name="montant_decouvert_autorise") private double montantDecouvertAutorise;
	private static int nbCompteCourants = 0;
	
	
	
	public CompteCourant(int numero, String libelle, double solde, double montantDecouvertAutorise) {
